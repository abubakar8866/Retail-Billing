...
const CustomerForm = ({customerName,mobileNumber,setMobileNumer,setCustomerName}) => {
    return(
        <div className="p-0">
            <div className="mb-3">
            ...
            <div className="mb-3">
                <div className="d-flex align-items-center gap-2">
                    ...
                    <input type="text" className="form-control form-control-sm" id="mobileNumber" onChange={(e) => setMobileNumer(e.target.value)} value={mobileNumber}/>
                </div>
            </div>
        </div>
    );
